...
if [ ! -d "$RAG_DIR" ]; then
    ...
    echo "Please run this script from blueprints/inference/nvidia-deep-research/ directory"
    echo "Or ensure the rag repository is cloned at the expected location"
    exit 1
fi
